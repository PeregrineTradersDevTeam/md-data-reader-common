...
public class Pcap extends KaitaiStruct {
    ...
    private void _read() {
        ...
        this.packets = new PacketEntries(this._io, this, _root);
    }
    public static class PacketEntries extends KaitaiStruct {
        public static PacketEntries fromFile(String fileName) throws IOException {
            return new PacketEntries(new ByteBufferKaitaiStream(fileName));
        }

        public PacketEntries(KaitaiStream _io) {
            this(_io, null, null);
        }

        public PacketEntries(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public PacketEntries(KaitaiStream _io, KaitaiStruct _parent, Pcap _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            this.entry = new Packet(this._io, null, _root);
        }
        private ArrayList<PacketEntries> nextEntries;
        public ArrayList<PacketEntries> nextEntries() {
            if (this.nextEntries != null)
                return this.nextEntries;
            nextEntries = new ArrayList<PacketEntries>((int) (1));
            for (int i = 0; i < 1 && !this._io.isEof(); i++) {
                this.nextEntries.add(new PacketEntries(this._io, null, _root));
            }
            return this.nextEntries;
        }
        private Packet entry;
        private Pcap _root;
        private KaitaiStruct _parent;
        public Packet entry() { return entry; }
    ...
    public static class Header extends KaitaiStruct {
        ...
        private void _read() {
            this.magicNumber = this._io.ensureFixedContents(new byte[] { 77, 60, -78, -95 });
    ...
    public static class Packet extends KaitaiStruct {
        ...
        public Packet(KaitaiStream _io, Pcap.PacketEntries _parent) {
            this(_io, _parent, null);
        }

        public Packet(KaitaiStream _io, Pcap.PacketEntries _parent, Pcap _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private Object body;
        private Pcap _root;
        private Pcap.PacketEntries _parent;
        ...
        public Pcap _root() { return _root; }
        public Pcap.PacketEntries _parent() { return _parent; }
        public byte[] _raw_body() { return _raw_body; }
    }
    private Header hdr;
    private PacketEntries packets;
    private Pcap _root;
    private KaitaiStruct _parent;
    public Header hdr() { return hdr; }
    public PacketEntries packets() { return packets; }
    public Pcap _root() { return _root; }
    public KaitaiStruct _parent() { return _parent; }
}
